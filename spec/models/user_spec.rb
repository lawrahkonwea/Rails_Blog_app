...
RSpec.describe User, type: :model do
    ...
    describe 'three_recent_posts' do
      let!(:post1) { Post.create(title: 'Post 1', text: 'Post body', author: @user, comment_counter: 0, likes_counter: 0) }
      let!(:post2) { Post.create(title: 'Post 2', text: 'Post body', author: @user, comment_counter: 0, likes_counter: 0) }
      let!(:post3) { Post.create(title: 'Post 3', text: 'Post body', author: @user, comment_counter: 0, likes_counter: 0) }
